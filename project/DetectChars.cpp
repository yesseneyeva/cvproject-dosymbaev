...
bool loadKNNDataAndTrainKNN(void) {
    ...
    cv::FileStorage fsClassifications("/Users/dosymbaev/Documents/Computer Vision Labs/classifications.xml", cv::FileStorage::READ);        // open the classifications file
    ...
    cv::FileStorage fsTrainingImages("/Users/dosymbaev/Documents/Computer Vision Labs/images.xml", cv::FileStorage::READ);              // open the training images file
